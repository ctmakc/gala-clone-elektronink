      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-16">
        <div className="flex gap-4 items-start rounded-lg">
          ...
          <div>
            ...
            <p className="text-slate-500 mt-2 leading-relaxed">Гала автоматично знаходит потенційних клієнтів, заповнює контактні форми та збирає актуальні дані для вашої воронки продажів.</p>
          </div>
        </div>
        <div className="flex gap-4 items-start rounded-lg">
          <div className="mt-1 rounded-full p-2 w-8 h-8 shrink-0 text-[#0ff4c6]">
